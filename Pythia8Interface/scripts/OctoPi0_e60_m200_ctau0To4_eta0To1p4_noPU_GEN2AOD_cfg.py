...
process.AODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:step_AODSIM_noPU.root'),
...
process.generator = cms.EDFilter("Pythia8EGunV2",
    PGunParameters = cms.PSet(
        ...
        MaxE = cms.double(60.),
        MinE = cms.double(59.),
        MaxCTau = cms.double(4.),
        MinCTau = cms.double(0.),
        ParticleID = cms.vint32(111,111,111,111)
        #ParticleID = cms.vint32(25,25,25,25)
    ),
