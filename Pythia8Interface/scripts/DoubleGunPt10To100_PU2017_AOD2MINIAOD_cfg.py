...
# with command line options: miniAOD-prod --filein file:step_AODSIM.root --fileout file:step_MINIAODSIM.root --mc --eventcontent MINIAODSIM --runUnscheduled --datatier MINIAODSIM --conditions 94X_mc2017_realistic_v14 --step PAT --scenario pp --era Run2_2017,run2_miniAOD_94XFall17 --python_filename DoubleGunPt10To100_PU2017_AOD2MINIAOD_cfg.py --no_exec
...
process.MINIAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:step_MINIAODSIMext4.root'),
